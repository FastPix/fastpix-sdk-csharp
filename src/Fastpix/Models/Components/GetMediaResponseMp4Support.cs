...
namespace Fastpix.Models.Components
{
    ...
    /// </remarks>
    /// </summary>
    public enum GetMediaResponseMp4Support
    {
        [JsonProperty("none")]
        None,
    ...
    public static class GetMediaResponseMp4SupportExtension
    {
        public static string Value(this GetMediaResponseMp4Support value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static GetMediaResponseMp4Support ToEnum(this string value)
        {
            foreach(var field in typeof(GetMediaResponseMp4Support).GetFields())
            {
