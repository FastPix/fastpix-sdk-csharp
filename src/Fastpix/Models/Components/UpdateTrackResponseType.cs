        ...
        public static UpdateTrackResponseType ToEnum(this string value)
        {
            foreach(var field in typeof(UpdateTrackResponseType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is UpdateTrackResponseType updateTrackResponseType)
                    {
                        return updateTrackResponseType;
                    }
                }
            }

            throw new ArgumentException($"Unknown value {value} for enum UpdateTrackResponseType", nameof(value));
        }
    }
