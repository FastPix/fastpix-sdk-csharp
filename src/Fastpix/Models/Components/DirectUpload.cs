...
namespace Fastpix.Models.Components
{
    ...
    public class DirectUpload
    {
        ...
        /// </summary>
        [JsonProperty("status")]
        public DirectUploadStatus? Status { get; set; }
        ...
        /// <summary>
        /// The duration set for the validity of the upload URL. If the upload isn&apos;t completed within this timespan, it&apos;s marked as timed out.<br/>
        /// 
        /// <remarks>
        /// 
        /// </remarks>
