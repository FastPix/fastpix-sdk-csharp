...
namespace Fastpix.Models.Components
{
    ...
    public class GetCreateLiveStreamResponseDTO
    {
        ...
        public GetCreateLiveStreamResponseDTOMetadata? Metadata { get; set; }

        /// <summary>
        /// A collection of Playback ID objects utilized for crafting HLS playback urls.
        /// </summary>
        [JsonProperty("playbackId")]
        public List<PlaybackIds>? PlaybackId { get; set; }

        /// <summary>
        /// This object contains the livestream playback response details for SRT Protocol.
        /// </summary>
        [JsonProperty("srtPlaybackResponse")]
        public GetCreateLiveStreamResponseDTOSrtPlaybackResponse? SrtPlaybackResponse { get; set; }
    }
}