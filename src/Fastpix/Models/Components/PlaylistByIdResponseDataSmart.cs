...
namespace Fastpix.Models.Components
{
    ...
    public class PlaylistByIdResponseDataSmart
    {
        ...
        /// </summary>
        [JsonProperty("type")]
        public PlaylistByIdResponseDataSmartType Type { get; set; } = default!;
        ...
        public PlaylistByIdResponseMetadata Metadata { get; set; } = default!;
