...
namespace Fastpix.Models.Components
{
    ...
    public class InputType
    {
        ...
        public static InputType PullVideoInput { get { return new InputType("PullVideoInput"); } }
        ...
        public static InputType FromString(string v) {
            switch(v) {
                case "PullVideoInput": return PullVideoInput;
    ...
    public class Input
    {
        ...
        public PullVideoInput? PullVideoInput { get; set; }
        ...
        public static Input CreatePullVideoInput(PullVideoInput pullVideoInput)
        {
            InputType typ = InputType.PullVideoInput;

            Input res = new Input(typ);
            res.PullVideoInput = pullVideoInput;
            return res;
        }
        ...
        public class InputConverter : JsonConverter
        {
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                try
                {
                    return new Input(InputType.PullVideoInput)
                    {
                        PullVideoInput = ResponseBodyDeserializer.DeserializeUndiscriminatedUnionMember<PullVideoInput>(json)
                    };
                }
                catch (ResponseBodyDeserializer.MissingMemberException)
                {
                    fallbackCandidates.Add((typeof(PullVideoInput), new Input(InputType.PullVideoInput), "PullVideoInput"));
                }
                catch (ResponseBodyDeserializer.DeserializationException)
                {
                    // try next option
            ...
            public override void WriteJson(JsonWriter writer, object? value, JsonSerializer serializer)
            {
                ...
                if (res.PullVideoInput != null)
                {
                    writer.WriteRawValue(Utilities.SerializeJSON(res.PullVideoInput));
                    return;
                }
