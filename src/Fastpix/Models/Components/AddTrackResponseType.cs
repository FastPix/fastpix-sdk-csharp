        ...
        public static AddTrackResponseType ToEnum(this string value)
        {
            foreach(var field in typeof(AddTrackResponseType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is AddTrackResponseType addTrackResponseType)
                    {
                        return addTrackResponseType;
                    }
                }
            }

            throw new ArgumentException($"Unknown value {value} for enum AddTrackResponseType", nameof(value));
        }
    }
